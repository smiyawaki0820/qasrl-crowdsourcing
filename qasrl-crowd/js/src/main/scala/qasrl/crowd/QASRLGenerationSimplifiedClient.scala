...
import qasrl.{Autocomplete, QuestionProcessor, TemplateStateMachine}
import qasrl.crowd.util.{MultiContigSpanHighlightableSentenceComponent, Styles}
...
class QASRLGenerationSimplifiedClient[SID : Reader : Writer](
        ...
        AsyncContentProps(
          ...
          render = {
            ...
            case Loaded(
              ...
              // In the simplified client, we no longer track accuracy online by other annotators
              // but by expert annotators in an offline setting
